...
$result = $connexion->query ($query);
$LigneMail[0] = '<p>Une demande de frais kilométriques a été créée par ' . $_SESSION['nom'] . ' ' . $_SESSION['prenom'] . '</b> pour <b>' . nomMois($_POST['mois']) . ' ' . $_POST['annee'] . '</b><br/><br/>Détails :</p>';
...
<html>
    <div align='center' class=''>
        <font color='green'>Note de frais kilométriques enregistrée</font>
    </div>
</html>