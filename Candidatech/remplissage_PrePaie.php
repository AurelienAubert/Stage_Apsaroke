...
//affiche le nom du col, les jours travaillés et le total des abs.
                foreach ($recup_abs as $id => $contenu) {
                    ...
                    <tr align="CENTER">
                        ...
                        <td><?php echo $jourouvre - $contenu['ABS']; ?><span>Jours travailés</span></td>
                        ...
                        <td><?php echo ''; ?><span>RTT</span></td>
                                    ...
                                    if (isset($element[5])) {
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span>Maladies</span></td>
                                        <?php
                                    } else {
                                        ?>
                        <td><?php echo ''; ?><span>Maladies</span></td>
                                        <?php
                                    }
                                    if (isset($element[6])) {
                                        ?>
                        ...
                        foreach ($recup_info_int as $id3 => $int) {
                            if ($id == $id3) {
                                if ($int[0] == true) {
                                    ?>
                        <td><?php echo floor($jourouvre - $contenu['ABS']); ?><span>Nombre <br/> Tickets Restaurants</span></td>
                                    <?php
                                } else {
                                    ?>
                                    <td><?php echo '0'; ?><span>Nombre <br/> Tickets Restaurants</span></td>
                                    <?php
                                }
                                if ($int[3] == true) {
                                    ?>
                                    <td><?php echo 'Oui'; ?><span>13éme mois</span></td>
                                    <?php
                                } else {
                                    ?>
                                    <td><?php echo 'Non'; ?><span>13éme mois</span></td>
                                    <?php
                                }
                                if ($int[1] != '0.00') {
                                    ?>
                                    <td><?php echo $int[1]; ?><span>GSM</span></td>
                                    <?php
                                } else {
                                    ?>
                                    <td><?php echo '0'; ?><span>GSM</span></td>
                                    <?php
                                }
                                if ($int[2] != '0.00') {
                                    ?>
                                    <td><?php echo $int[2]; ?><span>PEE</span></td>
                                    <?php
                                } else {
                                    ?>
                                    <td><?php echo '0'; ?><span>PEE</span></td>
                                    <?php
                                }
                                if ($mois == '11') {
                                    if ($int[4] != '0.00') {
                                        ?>
                                    <td><?php echo $int[4]; ?><span>13éme mois</span></td>
                                        <?php
                                    } else {
                                        ?>
                                        <td><?php echo '0'; ?><span>13éme mois</span></td>
                                        <?php
                                    }
                                }
                                if (isset($int[5])) {
                                    ?>
                                        <td><?php echo $int[5]; ?><span>Frais journaliers</span></td> 
                                    <?php
                                } else {
                                    ?>
                                    <td><?php echo '0'; ?><span>Frais journaliers</span></td>
                                    <?php
                                }
                            }
                        }
        ...
        <script type="text/javascript">
                                            function haut(idt) {
                                                if (document.getElementById(idt).scrollTop > 0)
                                                    aug(idt);
                                            }
                                            function aug(idt) {
