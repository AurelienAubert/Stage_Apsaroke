...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr"> 
    <head>
        ...
        <title>Visualiser une Pr&eacute; Paie</title>
    </head>
        ...
        <div class="container  ">
            ...
            <div class="row">
                <div class="offset3 span6 ">
                    <form action='remplissage_visualisationPrePaie.php' method="post" enctype="multipart/form-data" class="well" id="form2">
                                    <fieldset> 
                                        
                                        <legend><?php echo 'Visualiser Pr&eacute; Paie'; ?></legend> <br /><br />
                                        <div class="row">
                                            <div class="span2">
