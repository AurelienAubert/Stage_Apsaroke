...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr"> 
    ...
    <body>
        ...
        $bool = true;
                ...
                $query = "SELECT c.nom_col, a.id_tyabs, a.nbh_abs 
                ...
                ?>
                    <tr>
                        ...
                        {
                        ?>
                        <td bgcolor ='#C3F3EB' ALIGN="center"><?php echo stripslashes($ligne['nbh_abs']); ?></td>
                        <?php
                        }
                        else 
                        {
                        ...
                        {
                        ?>
                        <td bgcolor ='#94F6CA' ALIGN="center"><?php echo stripslashes($ligne['nbh_abs']); ?></td>
                        <?php
                        }
                        else 
                        {
                        ...
                        {
                        ?>
                        <td bgcolor ='#B6A781' ALIGN="center"><?php echo stripslashes($ligne['nbh_abs']); ?></td>
                        <?php
                        }
                        else 
                        {
                        ...
                        {
                        ?>
                        <td bgcolor ='#FCB2D8' ALIGN="center"><?php echo stripslashes($ligne['nbh_abs']); ?></td>
                        <?php
                        }
                        else 
                        {
        ...
        <!--endprint-->
        <br></br> 
        <input id="btnPrint" type="button" value="Print" onclick="doPrint()"></input>
        <a href ="affichage_TR.php" style="padding-left: 2em;"> Retour </a>
        <br></br>
