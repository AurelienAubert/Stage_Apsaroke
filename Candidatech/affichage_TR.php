...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr"> 
    <head>
        ...
        <title>Affichage des Tickets Restaurant</title>
    </head>
        ...
        <div class="container ">
            ...
            <div class="row">
                <div class="offset3 span6 ">
                    <form action='remplissageTableauTR.php' method="post" enctype="multipart/form-data" class="well" id="form2">
                        <fieldset> 
                                        
                            <legend><?php echo 'Affichage des Tickets Restaurant'; ?></legend> <br /><br />
                            <div class="row">
                                <div class="span2">
