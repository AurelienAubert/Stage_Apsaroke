            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div div class="well" id="formulaire">
                            ...
                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="detail" id="champDetail" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                        ...
                                        <div class="decalage">
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="mail" id="champMail" />
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="tel1" id="champTel1" required />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" name="tel2" id="champTel2" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" name="ville" id="champVille" />
                                                    </td>
                                                </tr>
                                            </table>
                                            <br>
                            ...
                            ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p title="(AAAA-MM-JJ)">Date Mise a jour:</p>
                                                    </td>
                                                    <td>
                                                        <input type="text" name="date" id="champDate" title="(AAAA-MM-JJ)" />
                                                    </td>
                                                </tr>
                    ...
                    ?>
                                    ...
                                    <table>
                                        <td>
                                            <p for="champCV">Piece Jointe :</p>
                                        </td>
                                        <td>
                                            <input type="file" title="Choisir un fichier a importer" name="cv" multiple="1" aria-label="Telecharger un CV" id="champCV">
                                        </td>
                                    </table>
                                    <br>
                       ...
                       +derniere lettre du Nom">MneMonic :</p>
                                    ...
                                    <div class='offset2 span2 '>
                                        <button class="btn btn-primary" type="submit">Ajouter le Candidat</button>
                                        <br>
                                        <br>
                                    </div>
                                </form>
                                <a href="CANDIindex.php">
                                    <button>Retour Index</button>
                                </a>
                            </fieldset>
                        </div>
                    </div>
